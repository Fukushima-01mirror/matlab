classdef TextDataOutput < Analyze.Base
    ...
    methods
        function obj = TextDataOutput(config,data)
        ...
        function runForPair(obj,user1,user2)
            ...
            if sum(isnan(cell2mat(obj.config.archiveDataFileName) )) == 0
	           zc1Filename = obj.saveFilePath(char(strcat('\CycleAcvData1.txt')));
            end
            ...
            if sum(isnan(cell2mat(obj.config.archiveDataFileName) )) == 0
	           zc2Filename = obj.saveFilePath(char(strcat('\CycleAcvData2.txt')));
            end
