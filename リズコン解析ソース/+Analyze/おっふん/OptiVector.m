classdef OptiVector < Analyze.Base
    ...
    methods
        function obj = OptiVector(config,data)
            obj = obj@Analyze.Base(config,data);
        end

        function runForAlone(obj,user)
          %%ファイル名設定
           optifilename = 'small2 2015-01-12 11.56.39 AM.csv';
           %Take 2014-11-20 11.13.37 PM.csv
           %dataname = 'DATA1_04.csv';
%%          Optiでのマーカーの変位
            optiData = xlsread(optifilename,1,'B46:C6045'); disp(0);
           
            optiData(1:6000,3:5) = xlsread(optifilename,1,'F46:H6045');disp('Hip1');
            optiData(1:6000,6:8) = xlsread(optifilename,1,'K46:M6045');disp('Hip2');
            optiData(1:6000,9:11) = xlsread(optifilename,1,'P46:R6045');disp('Hip3');
            optiData(1:6000,12:14) = xlsread(optifilename,1,'U46:W6045');disp('Hip4');
            ...
            optiData(1:6000,111:113) = xlsread(optifilename,1,'GD46:GF6045');disp('Marker37');
            ...
            opti0(1,111:113) = xlsread(optifilename,1,'GD45:GF45');
            disp('zeroEnd');
                 Vector1 = zeros(6000,112);
%                 Vector1 = zeros(6000,109);
            ...
            MonitorSize = [ 0, 0, 1200, 800];
             ...
             x=1:1:37;
                 y = [abs(Vector2(spotTimeMax,2)),abs(Vector2(spotTimeMax,3)),abs(Vector2(spotTimeMax,4)),abs(Vector2(spotTimeMax,5)),abs(Vector2(spotTimeMax,6)),...
                     ...
                     abs(Vector2(spotTimeMax,37)),abs(Vector2(spotTimeMax,38))];
             bar(x,y,0.4);
             disp('Now operating');
            
             
             xlabel({['マーカー番号    時刻:' num2str(0.02 * spotTimeMax)]});    ylabel('変位');
               xlim([0 37]);    ylim([0 0.02]);
                hold on
...
%             Another8 = Vector2(:,9);
%             Another9 = Vector2(:,10);
%             Another10 = Vector2(:,11);
%             Another11 = Vector2(:,12);
%             Another12 = Vector2(:,13);
%             Another13 = Vector2(:,14);
%             Another14 = Vector2(:,15);
%             Another15 = Vector2(:,16);
%             Another16 = Vector2(:,17);
%             Another17 = Vector2(:,18);
%             Another18 = Vector2(:,19);
%             Another19 = Vector2(:,20);
%             Another20 = Vector2(:,21);
%             Another21 = Vector2(:,22);
%             Another22 = Vector2(:,23);
%             Another23 = Vector2(:,24);
%             Another24 = Vector2(:,25);
%             Another25 = Vector2(:,26);
%             Another26 = Vector2(:,27);
%             Another27 = Vector2(:,28);
%             Another28 = Vector2(:,29);
%             Another29 = Vector2(:,30);
%             Another30 = Vector2(:,31);
%             Another31 = Vector2(:,32);
%             Another32 = Vector2(:,33);
%             Another33 = Vector2(:,34);
%             Another34 = Vector2(:,35);
%             Another35 = Vector2(:,36);
%             Another36 = Vector2(:,37);
%             
%             corr1 = corrcoef(Marker1,Another1);
%             corr2 = corrcoef(Marker2,Another2);
%             corr3 = corrcoef(Marker3,Another3);
%             corr4 = corrcoef(Marker4,Another4);
%             corr5 = corrcoef(Marker5,Another5);
%             corr6 = corrcoef(Marker6);
%             corr7 = corrcoef(,Marker7);
%             corr8 = corrcoef(,Marker8);
%             corr9 = corrcoef(,Marker9);
%             corr10 = corrcoef(,Marker10);
%             corr11 = corrcoef(,Marker11);
%             corr12 = corrcoef(,Marker12);
%             corr13 = corrcoef(,Marker13);
%             corr14 = corrcoef(,Marker14);
%             corr15 = corrcoef(,Marker15);
%             corr16 = corrcoef(,Marker16);
%             corr17 = corrcoef(,Marker17);
%             corr18 = corrcoef(,Marker18);
%             corr19 = corrcoef(,Marker19);
%             corr20 = corrcoef(,Marker20);
%             corr21 = corrcoef(,Marker21);
%             corr22 = corrcoef(,Marker22);
%             corr23 = corrcoef(,Marker23);
%             corr24 = corrcoef(,Marker24);
%             corr25 = corrcoef(,Marker25);
%             corr26 = corrcoef(,Marker26);
%             corr27 = corrcoef(,Marker27);
%             corr28 = corrcoef(,Marker28);
%             corr29 = corrcoef(,Marker29);
%             corr30 = corrcoef(,Marker30);
%             corr31 = corrcoef(,Marker31);
%             corr32 = corrcoef(,Marker32);
%             corr33 = corrcoef(,Marker33);
%             corr34 = corrcoef(,Marker34);
%             corr35 = corrcoef(,Marker35);
%             corr36 = corrcoef(,Marker36);
%             
