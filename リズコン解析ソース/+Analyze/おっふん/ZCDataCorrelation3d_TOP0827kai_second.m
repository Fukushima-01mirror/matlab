classdef ZCDataCorrelation3d_TOP0827kai_second < Analyze.Base
    ...
    methods
        function obj = ZCDataCorrelation3d_TOP0827kai_second(config,data)
...
%             end
            ...
            IndexFormer = find(Time_zc(:) > 0 & Time_zc(:) < 60000);
