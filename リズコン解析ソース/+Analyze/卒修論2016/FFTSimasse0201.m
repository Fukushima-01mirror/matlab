classdef FFTSimasse0201 < Analyze.Base
    ...
    methods
        function obj = FFTSimasse0201(config,data)
            obj = obj@Analyze.Base(config,data);
        end

        function runForAlone(obj,user)
          %%ファイル名設定
           filename ='0201加藤福島自由_sd1.csv';
           sheet = 1;
...
%             timeData = data.Frame / fs;
            ...
            y = xlsread(filename,sheet,'C1:C524288');disp('xlsreading...');
