classdef ZCDataCorrelation3d_seekAxis_ex_small0708 < Analyze.Base
    ...
    methods
        function obj = ZCDataCorrelation3d_seekAxis_ex_small0708(config,data)
...
%             set(gcf, 'Position', [0 0 500 500]);
           ...
           if ~isempty(strfind( char(obj.config.examType) , '剣道対戦'))
                ...
                obj.saveGraphWithName('_主成分回帰分析F2');
           end
            %%           主成分回帰分析2
            set(gcf, 'Position', [ 0, 0, 500, 500]);    bFig = 1;
...
%             set(gcf, 'Position', [0 0 500 500]);
           ...
           if ~isempty(strfind( char(obj.config.examType) , '剣道対戦'))
                ...
                obj.saveGraphWithName('_主成分回帰分析L2');
            end
