classdef ZCDataCorrelation3d_seekAxis_ex_small_0731 < Analyze.Base
    ...
    methods
        function obj = ZCDataCorrelation3d_seekAxis_ex_small_0731(config,data)
...
%             end
            ...
            IndexFormer = find(Time(:) > 0 & Time(:) < 14220);
