classdef ZCDataCorrelation3d_seekAxis_ex_small_TOP_Divide_0731kai_second < Analyze.Base
    ...
    methods
        function obj = ZCDataCorrelation3d_seekAxis_ex_small_TOP_Divide_0731kai_second(config,data)
...
%             end
            ...
            IndexFormer = find(Time_zc(:) > 0 & Time_zc(:) < 38000);
            ...
            Index_H = find(Time_zc(:) > 0 & Time_zc(:) < 11000);
...
%             [k1 , k2, X1, fitParam_X1Y, fitLineR_X1Y] = Rhythm.PCA_regress_3dplot(dT_zcF , dA_zcF , Y_zcF , bFig) ;
            hold on
                ...
                plot3(dT_zcH, dA_zcH , Y_zcH ,'Color' , 'r' ,'Marker','.', 'LineStyle','none' );
