classdef ZCDataCorrelation3d_seekAxis_ex_small_TOP_TimeDivide_0731kai < Analyze.Base
    ...
    methods
        function obj = ZCDataCorrelation3d_seekAxis_ex_small_TOP_TimeDivide_0731kai(config,data)
