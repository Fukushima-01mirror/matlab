classdef ZCDataCorrelation3d_seekAxis_ex < Analyze.Base
    ...
    methods
        function obj = ZCDataCorrelation3d_seekAxis_ex(config,data)
...
%%
            ...
            if ~isempty(strfind( char(obj.config.examType) , '剣道対戦'))
                ...
                obj.saveGraphWithName('_回帰分析(ΔA-ΔT)');
            end
...
%%
            ...
            if ~isempty(strfind( char(obj.config.examType) , '剣道対戦'))
                ...
                obj.saveGraphWithName('_座標変換X1X2');
            end
...
%%
            ...
            if ~isempty(strfind( char(obj.config.examType) , '剣道対戦'))
                ...
                obj.saveGraphWithName('_単回帰分析(V-ΔT,V-ΔA,V-X1)');
            end
...
%%
            ...
            if ~isempty(strfind( char(obj.config.examType) , '剣道対戦'))
                ...
                obj.saveGraphWithName('_重回帰分析（V-ΔT,ΔA）');
            end
...
%%
            ...
            if ~isempty(strfind( char(obj.config.examType) , '剣道対戦'))
                ...
                obj.saveGraphWithName('_重回帰分析(V-X1,X2)');
            end
