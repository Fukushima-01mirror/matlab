classdef ZCData_3dPlot_axis_timeShift_fk4_20160827_2 < Analyze.Base
    ...
    methods
        function obj = ZCData_3dPlot_axis_timeShift_fk4_20160827_2(config,data)
...
%                       plot([spotTimeMax-spotTime+1 spotTimeMax-spotTime+1],[0 1000],'--k');
  %                      plot([spotTimeMax spotTimeMax],[0 1000],'--k');
                        ...
                        [hAx,hLine1,hLine2] = plotyy(x,y1,x,y3);
