classdef ZCData_3dPlot_axis_timeShift_fk_ < Analyze.Base
    ...
    methods
        function obj = ZCData_3dPlot_axis_timeShift_fk_(config,data)
...
%            disp(length(AB_Series_Max(:,2)));
            ...
            dT_border = 50;
            k_border =2;
            indexG0 = find( dT_zc < dT_border & dA_zc < dA_border & Time_zc <= 60000 & Time_zc > 30000);
            indexG01 = find( dT_zc >= dT_border & (dA_zc)./dT_zc <= k_border & Time_zc <= 60000 & Time_zc > 30000);
            indexG02 = find( dA_zc >= dA_border & (dA_zc)./dT_zc > k_border & Time_zc <= 60000 & Time_zc > 30000);
            indexG1 = sort([indexG0 ; indexG01]);
            indexG2 = sort([indexG0 ; indexG02]);
            indexG0_2 = find( dT_zc2 < dT_border & dA_zc2 < dA_border & Time_zc2 <= 60000 & Time_zc2 > 30000);
            indexG01_2 = find( dT_zc2 >= dT_border & (dA_zc2)./dT_zc2 <= k_border & Time_zc2 <= 60000 & Time_zc2 > 30000);
            indexG02_2 = find( dA_zc2 >= dA_border & (dA_zc2)./dT_zc2 > k_border & Time_zc2 <= 60000 & Time_zc2 > 30000);
...
%             
                ...
                startIndex = find( user1.zeroCrossData.zeroCrossTime(IndexZeroCross) >= 30000 ,1 ,'first');
                endIndex = find( user1.zeroCrossData.zeroCrossTime(IndexZeroCross) <60000 ,1 ,'last');  
                startIndex2 = find( user2.zeroCrossData.zeroCrossTime(IndexZeroCross2) >= 30000 ,1 ,'first');
...
%                      end
                 ...
                 obj.saveGraphWithNameToFolder('30000以後');
                end
