classdef ZCData_3dPlot_axis_timeShift_sudo_HI2 < Analyze.Base
    ...
    methods
        function obj = ZCData_3dPlot_axis_timeShift_sudo_HI2(config,data)
...
%            disp(length(AB_Series_Max(:,2)));
            ...
            indexG0_2 = find( dT_zc2 < dT_border2 & dA_zc2 < dA_border2 );
            indexG01_2 = find( dT_zc2 >= dT_border2 & (dA_zc2)./dT_zc2 <= k_border2 );
            indexG02_2 = find( dA_zc2 >= dA_border2 & (dA_zc2)./dT_zc2 > k_border2 );
...
%                     plot3(dT_zc , dA_zc , Y_zc ,'Marker','o','MarkerEdgeColor' , [.7 .7 .7] , 'LineStyle','none','MarkerSize',5);
                ...
                title({ ['player1 θ1 = ' num2str(atan(dy/dx)*360/2/pi) ' , φ1 = ' num2str(atan(fitParam_X1Y_g1(1))*360/2/pi) ', 傾き1：' num2str( fitParam_X1Y_g1(1) )];...
                    ['切片1：' num2str(fitParam_X1Y_g1(2)) '，相関係数R1：' num2str( fitLineR_X1Y_g1(1)) '，決定係数R^2_1：' num2str( fitLineR_X1Y_g1(1)^2)];...
                    ['θ2 = ' num2str(atan(dy2/dx2)*360/2/pi) ' , φ2 = ' num2str(atan(fitParam_X1Y_g2(2))*360/2/pi) ', 傾き2：' num2str( fitParam_X1Y_g2(1) )];...
                    ['切片2：' num2str(fitParam_X1Y_g2(2)) '，相関係数R1：' num2str( fitLineR_X1Y_g2(1)) '，決定係数R^2_1：' num2str( fitLineR_X1Y_g2(1)^2)]});
                
                axis square
                obj.saveGraphWithNameToFolder('sub1');
...
%                     plot3(dT_zc2(1:length(dT_zc2)*2/3) , dA_zc2(1:length(dT_zc2)*2/3) , Y_zc2(1:length(dT_zc2)*2/3) ,'Marker','o','MarkerEdgeColor' , [.7 .7 .7] , 'LineStyle','none','MarkerSize',5);
                    
                    plot3(dT_zc2(indexGd1_2) , dA_zc2(indexGd1_2) , Y_zc2(indexGd1_2) ,'MarkerEdgeColor' , 'b' ,'MarkerFaceColor','b', 'Marker','o', 'LineStyle','none','MarkerSize',5);
                    plot3(dT_zc2(indexGd2_2) , dA_zc2(indexGd2_2) , Y_zc2(indexGd2_2) ,'MarkerEdgeColor' , [0 .5 0],'MarkerFaceColor',[0 .5 0], 'Marker','o', 'LineStyle','none','MarkerSize',5);

                    plot3(  [ -100*k1_g1_2 ; 500*k1_g1_2 ] + mean(dT_zc2(indexG1_2)) , [ -100*k2_g1_2 ; 500*k2_g1_2 ] + mean(dA_zc2(indexG1_2)) , zeros(2,1) , 'r');
                    plot3( lineEdgePoint_X1Y_g1_2(:,1) + mean(dT_zc2(indexG1_2)) , lineEdgePoint_X1Y_g1_2(:,2) + mean(dA_zc2(indexG1_2)), lineEdgePoint_X1Y_g1_2(:,3) ,'r' ,'LineWidth',3 );
...
%                     plot3( lineEdgePoint_X1Y_g1_2(:,1) + mean(dT_zc2) , lineEdgePoint_X1Y_g1_2(:,2) + mean(dA_zc2), lineEdgePoint_X1Y_g1(:,3) ,'r' ,'LineWidth',3 );
...
%                            [0 lineEdgePoint_X1Y_g1_2(2,3)] ,'--r' );              % 垂線
                ...
                title({ ['player2 θ1 = ' num2str(atan(dy_2/dx_2)*360/2/pi) ' , φ1 = ' num2str(atan(fitParam_X1Y_g1_2(1))*360/2/pi) ', 傾き1：' num2str( fitParam_X1Y_g1_2(1) )];...
                    ['切片1：' num2str(fitParam_X1Y_g1_2(2)) '，相関係数R1：' num2str( fitLineR_X1Y_g1_2(1)) '，決定係数R^2_1：' num2str( fitLineR_X1Y_g1_2(1)^2)];...
                    ['θ2 = ' num2str(atan(dy2_2/dx2_2)*360/2/pi) ' , φ2 = ' num2str(atan(fitParam_X1Y_g2_2(2))*360/2/pi) ', 傾き2：' num2str( fitParam_X1Y_g2_2(1) )];...
                    ['切片2：' num2str(fitParam_X1Y_g2_2(2)) '，相関係数R2：' num2str( fitLineR_X1Y_g2_2(1)) '，決定係数R^2_2：' num2str( fitLineR_X1Y_g2_2(1)^2)]});
...
%                         end
%                         area([4000 5000],[1000 1000],'FaceColor',[1 .9 1],'EdgeColor',[1 .9 1]);
% 
...
%                         end
%                         area([4000 5000],[800 800],'FaceColor',[1 .9 1],'EdgeColor',[1 .9 1],'basevalue',-400);
%                     
%                         plot([0 60000],[0 0],'k');
...
%                     if ~isempty(strfind( char(obj.config.examType) , '剣道対戦'))
                        obj.saveGraphWithNameToFolder('sub2');
