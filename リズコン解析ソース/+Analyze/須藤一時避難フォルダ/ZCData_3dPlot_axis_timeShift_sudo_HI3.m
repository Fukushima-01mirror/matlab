classdef ZCData_3dPlot_axis_timeShift_sudo_HI3 < Analyze.Base
    ...
    methods
        function obj = ZCData_3dPlot_axis_timeShift_sudo_HI3(config,data)
...
%                         area([900 1500],[800 800],'FaceColor',[.7 1 1],'EdgeColor','none','basevalue',-400);
