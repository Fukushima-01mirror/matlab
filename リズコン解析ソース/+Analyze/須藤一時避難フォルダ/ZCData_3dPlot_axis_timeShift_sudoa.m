classdef ZCData_3dPlot_axis_timeShift_sudoa < Analyze.Base
    ...
    methods
        function obj = ZCData_3dPlot_axis_timeShift_sudoa(config,data)
...
%                     time_s = zeros(100,1);
%                     time_e = zeros(100,1);
%                     group_d_fixed = zeros(length(user1.time.highSampled),1);
%                     times_zc=1;
%                     for(i = Time_zc(1) : user1.time.highSampled(end))
%                         group_d_fixed(i-19)=group_d_fixed(i-20);
%                         if(i==Time_zc(times_zc))
%                             group_d_fixed(i-19)=group_d(times_zc);
%                             if(times_zc<length(Time_zc)) times_zc = times_zc + 1;    end
%                         end
%                     end
%                 %直線２の時間帯検出
%                     for(i = 21 : user1.time.highSampled(end))
%                         if(group_d_fixed(i-19) == 2 && group_d_fixed(i-20) < 2)
%                                 time_s(n_group) = user1.time.highSampled(i-19);
%                         elseif(group_d_fixed(i-19) == 1 && group_d_fixed(i-20) == 2)
%                                 time_e(n_group) = user1.time.highSampled(i-19);
%                         end
%                         
...
%                     times_zc2=1;
%                     for(i=Time_zc2(1):user2.time.highSampled(end))
%                         group_d_fixed2(i-19)=group_d_fixed2(i-20);
%                         if(i==Time_zc2(times_zc2))
%                             group_d_fixed2(i-19)=group_d_2(times_zc2);
%                             if(times_zc2<length(Time_zc2)) times_zc2 = times_zc2 + 1;    end
%                         end
%                     end
%                 %直線２の時間帯検出
%                     for(i = 21:user2.time.highSampled(end))
%                         if(group_d_fixed2(i-19) == 2 && group_d_fixed2(i-20) < 2)
%                                 time_s_2(n_group_2) = user2.time.highSampled(i-19);
%                         elseif(group_d_fixed2(i-19) == 1 && group_d_fixed2(i-20) == 2)
%                                 time_e_2(n_group_2) = user2.time.highSampled(i-19);
%                         end
%                         
...
%                     b = plot( user2.zeroCrossData.zeroCrossTime , abs(period_zx2(:,3)) , 'g');
                    c = plot( user1.zeroCrossData.zeroCrossTime , abs(peak_zx(:,3)) , 'g' );
...
%                     plot([spotTimeMax-spotTime+1 spotTimeMax-spotTime+1],[0 1000],'--k');
%                     plot([spotTimeMax spotTimeMax],[0 1000],'--k');
                    b = plot( user2.zeroCrossData.zeroCrossTime , abs(period_zx2(:,3)) , 'b');
%                     c = plot( user1.zeroCrossData.zeroCrossTime , abs(peak_zx(:,3)) , 'g' ,'LineWidth',2.5 );
                    d = plot( user2.zeroCrossData.zeroCrossTime , abs(peak_zx2(:,3)) , 'g' );
