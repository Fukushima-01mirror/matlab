...
%             indexG2 = indexG02;
            ...
            indexG1 = find( (dA_zc)./dT_zc <= k_border & (dA_zc)./dT_zc >= k_border1 );
            indexG2 = find( (dA_zc)./dT_zc > k_border );
            indexG3 = find( (dA_zc)./dT_zc < k_border1 );
            ...
            plot3( dT_zc(indexG3), dA_zc(indexG3), abs(Y_zc(indexG3)), 'Color', [0.6,0,0.6], 'Marker', '*', 'LineStyle', 'none' );
...
%             plot3(  [ -100*k1_g3 ; 500*k1_g3 ] + mean(dT_zc(indexG3)) , [ -100*k2_g3 ; 500*k2_g3 ] + mean(dA_zc(indexG3)) , zeros(2,1) , 'r' );
%             plot3( lineEdgePoint_X1Y_g3(:,1) + mean(dT_zc(indexG3)) , lineEdgePoint_X1Y_g3(:,2) + mean(dA_zc(indexG3)), lineEdgePoint_X1Y_g3(:,3) ,'r' ,'LineWidth',3 );
%             plot3( [ lineEdgePoint_X1Y_g3(2,1) + mean(dT_zc(indexG3)) ,lineEdgePoint_X1Y_g3(2,1)+ mean(dT_zc(indexG3)) ] ,...
%                 [ lineEdgePoint_X1Y_g3(2,2)+ mean(dA_zc(indexG3)) , lineEdgePoint_X1Y_g3(2,2)+ mean(dA_zc(indexG3)) ] ,...
%                 [0 lineEdgePoint_X1Y_g3(2,3)] ,'--r' );              % 垂線
