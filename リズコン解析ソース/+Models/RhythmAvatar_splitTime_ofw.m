classdef RhythmAvatar_splitTime_ofw < Models.DataAbstruct
...
%{
    ...
    methods
        function obj = RhythmAvatar_splitTime_ofw(filename, match_data ,suffix)
             propertyNames = { ...
                'time.lowSampled' ...               %
            ...
            if data0(end,1) ~= 60000
                data0 = vertvat(data0,zeros(1,5));
                data0(end,:) = data0(end-1,:);
                data0(end,1) = 60000;
            end
            
            data0_fixed = zeros(3000,5);
            ...
            while(1)
                if data0(a,1) ~= data0(a-1,1)+20
                    ...
                    fix_data_1 = zeros(1,5);                        %1欠損あたりの数値
