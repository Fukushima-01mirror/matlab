function[Pul, avt_data, cycle_data, Err] = rhythmAvt2_cycle_data_func(tempPul, data0, cnst_a, cnst_b)
...
Err_1_border = 100; %Err(?,1)のボーダー100→20
Err_2_border = 20;  %Err(?,1)のボーダー10→3
    ...
    for signPul0 =1:2     %コントローラ操作量の初期値の正負
        ...
        if signPul0 == 1      %初期値マイナス 
            [avt_temp_data1, cycle_data1] ...
                = Rhythm.rhythm2_temp_cycle_data(data0(1,2), tempPul, cnst_a, cnst_b, -(Pul0-1), 0);
            [avt_temp_data2, cycle_data2] ...
                = Rhythm.rhythm2_temp_cycle_data(data0(1,2), tempPul, cnst_a, cnst_b, -(Pul0-1), 1);
...
if Pul0 ==2    %初期値マイナス
    [avt_temp_data1, cycle_data1] ...
        = Rhythm.rhythm2_temp_cycle_data(data0(1,2), tempPul, cnst_a, cnst_b, (Pul0-2), 0);
    [avt_temp_data2, cycle_data2] ...
        = Rhythm.rhythm2_temp_cycle_data(data0(1,2), tempPul, cnst_a, cnst_b, -(Pul0-2), 1);
