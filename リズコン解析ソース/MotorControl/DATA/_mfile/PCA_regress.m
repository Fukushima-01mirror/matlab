function [k1 , k2, X1, fitParam_X1Y, fitLineR_X1Y,  distError , distMean] = PCA_regress(dT_zc , dA_zc , Y_zc , bFig) 
        
            Nzc = length(Y_zc) ;
            
        %主成分分析
        [coeff,score,latent,tsquare] = princomp_( [dT_zc dA_zc] );
        ...
        %回帰分析
        [ fitParam_X1Y, fitLineR_X1Y, lineEdgePoint_X1Y] = approxiLine2d(X1, Y_zc );
