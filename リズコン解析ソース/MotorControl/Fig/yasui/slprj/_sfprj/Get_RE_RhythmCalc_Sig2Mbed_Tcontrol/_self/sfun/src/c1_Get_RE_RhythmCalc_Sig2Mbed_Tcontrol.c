...
#include "c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_sfun_debug_macros.h"
...
static void initialize_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void initialize_params_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void enable_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void disable_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void set_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance, const
   mxArray *c1_st);
static void finalize_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void sf_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void initSimStructsc1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void registerMessagesc1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
...
static uint8_T c1_d_emlrt_marshallIn
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance, const
   mxArray *c1_b_is_active_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol, const char_T *
   c1_identifier);
  ...
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol = 0U;
}
  ...
  (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal =
    chartInstance->c1_is_active_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
   ...
   mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol =
    ...
    "is_active_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance;
  chartInstance = (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_get_eml_resolved_functions_info
  (void)
{
   ...
   c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol);
  return c1_y;
}
...
void sf_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
  initialize_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void
  *chartInstanceVar)
{
  enable_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void
  *chartInstanceVar)
{
  disable_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void
  *chartInstanceVar)
{
  sf_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(S);
}

static void sf_opaque_set_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(S, st);
}

static void sf_opaque_terminate_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
      ((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(SimStruct *S)
{
  SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance;
  chartInstance = (SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *)
    utMalloc(sizeof(SFc1_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
...
void c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_method_dispatcher.\n"
