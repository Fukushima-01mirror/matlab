...
#include "c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol.h"
...
static void initialize_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void initialize_params_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void enable_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void disable_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void set_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance, const
   mxArray *c5_st);
static void finalize_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void sf_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void initSimStructsc5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void registerMessagesc5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static void c5_info_helper(c5_ResolvedFunctionInfo c5_info[25]);
static void c5_eml_error(SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *
  chartInstance);
static real_T c5_emlrt_marshallIn
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance, const
   mxArray *c5_A12, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance, const
   mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_emlrt_marshallIn
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance, const
   mxArray *c5_X1, const char_T *c5_identifier, real_T c5_y[12]);
static void c5_d_emlrt_marshallIn
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance, const
   mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[12]);
static uint8_T c5_e_emlrt_marshallIn
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance, const
   mxArray *c5_b_is_active_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol, const char_T *
   c5_identifier);
  ...
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol = 0U;
}
  ...
  (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance)
{
  ...
  c5_d_u = chartInstance->c5_is_active_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  c5_e_y = NULL;
   ...
   mxArray *c5_st)
{
  ...
  *c5_B12 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
  ...
  c5_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 2)), "X1",
                        *c5_X1);
  chartInstance->c5_is_active_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol =
    c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 3)),
    "is_active_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol");
  sf_mex_destroy(&c5_u);
   ...
   c5_identifier)
{
  ...
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol);
  return c5_y;
}
...
void sf_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[21],T\"A12\",},{M[1],M[22],T\"B12\",},{M[1],M[14],T\"X1\",},{M[8],M[0],T\"is_active_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void
  *chartInstanceVar)
{
  initialize_params_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
  initialize_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void
  *chartInstanceVar)
{
  enable_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void
  *chartInstanceVar)
{
  disable_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void
  *chartInstanceVar)
{
  sf_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol();/* state var info */
...
extern void sf_internal_set_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(S);
}

static void sf_opaque_set_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(S, st);
}

static void sf_opaque_terminate_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
      ((SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
    ((SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(SimStruct *S)
{
...
static void mdlStart_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(SimStruct *S)
{
  SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *chartInstance;
  chartInstance = (SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct *)
    utMalloc(sizeof(SFc5_Get_RE_RhythmCalc_Sig2Mbed_TcontrolInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol;
...
void c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_method_dispatcher.\n"
