  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver") == 0)
  {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver") == 0)
  {
    ...
    newRhs[2] = prhs[3];
    return
      sf_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_third_party_uses_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int
  sf_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_method_dispatcher(SimStruct
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver")) {
    return(sf_Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_method_dispatcher
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_terminator();
...
extern void
  Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_register_exported_symbols
  (SimStruct* S);
extern void Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_debug_initialize(
    struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    Get_RE_RhythmCalc_Sig2Mbed_Tcontrol_paper_ver_initializer();
  }
