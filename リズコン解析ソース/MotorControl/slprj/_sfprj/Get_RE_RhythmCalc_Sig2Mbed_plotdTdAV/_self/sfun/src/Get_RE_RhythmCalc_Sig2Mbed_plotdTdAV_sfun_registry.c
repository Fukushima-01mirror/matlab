...
{
  extern unsigned int
    sf_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV") == 0) {
    ...
    newRhs[1] = prhs[2];
    return
      sf_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV")) {
    return(sf_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_method_dispatcher
...
extern void Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_terminator();
...
extern void Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_initializer(void);
extern void Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_register_exported_symbols
  (SimStruct* S);
extern void Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV_initializer();
  }
