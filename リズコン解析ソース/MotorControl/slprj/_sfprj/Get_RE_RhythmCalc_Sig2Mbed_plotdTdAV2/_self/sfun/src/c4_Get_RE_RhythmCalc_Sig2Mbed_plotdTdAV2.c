...
static void initialize_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance);
static void initialize_params_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance);
static void enable_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance);
static void disable_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance);
static void set_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance,
   const mxArray *c4_st);
static void finalize_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance);
static void sf_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance);
static void initSimStructsc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance);
static void registerMessagesc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance);
...
static uint8_T c4_emlrt_marshallIn
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance,
   const mxArray *c4_b_is_active_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2, const
  ...
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2 = 0U;
}
  ...
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance)
{
  ...
  c4_u = chartInstance->c4_is_active_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  c4_b_y = NULL;
   ...
   const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2 =
    c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 0)),
                        "is_active_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2");
  sf_mex_destroy(&c4_u);
  ...
  (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance)
{
  ...
  static char_T c4_cv6[4] = { 'd', 'A', '\x81', 'f' };
  ...
  for (c4_ixstart = 0; c4_ixstart < 4; c4_ixstart++) {
    c4_bb_u[c4_ixstart] = c4_cv6[c4_ixstart];
  }

  c4_bb_y = NULL;
  sf_mex_assign(&c4_bb_y, sf_mex_create("y", c4_bb_u, 10, 0U, 1U, 0U, 2, 1, 4),
                FALSE);
   ...
   char_T *c4_identifier)
{
  ...
  c4_y = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2);
  return c4_y;
}
...
void sf_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2554324642U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1593107709U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(677624160U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(330637042U);
}

mxArray *sf_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2_get_autoinheritance_info
  (void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("bEydbr1p98IKb9GRmDfEgD");
...
mxArray *sf_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2_get_check_sum(&mxChecksum);
...
{
  return "eTlMmNfSylYVJIRuDI9cGB";
}

static void sf_opaque_initialize_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(void
  *chartInstanceVar)
{
  initialize_params_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
    ((SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct*)
     chartInstanceVar);
  initialize_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
    ((SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(void
  *chartInstanceVar)
{
  enable_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
    ((SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(void
  *chartInstanceVar)
{
  disable_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
    ((SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(void
  *chartInstanceVar)
{
  sf_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
    ((SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
    ((SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2();/* state var info */
...
extern void sf_internal_set_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
    ((SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(S);
}

static void sf_opaque_set_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(S, st);
}

static void sf_opaque_terminate_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
      ((SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
    ((SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(456819456U));
  ssSetChecksum1(S,(4267252778U));
  ssSetChecksum2(S,(4125903559U));
  ssSetChecksum3(S,(1870090477U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(SimStruct *S)
{
...
static void mdlStart_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(SimStruct *S)
{
  SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *chartInstance;
  chartInstance = (SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct *)
    utMalloc(sizeof(SFc4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2;
...
void c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Get_RE_RhythmCalc_Sig2Mbed_plotdTdAV2_method_dispatcher.\n"
