classdef RhythmAvatar_oldPara < Models.DataAbstruct
...
%{
    ...
    methods
        function obj = RhythmAvatar_oldPara(filename,suffix)
             propertyNames = { ...
                'time.lowSampled' ...               %
            ...
            if suffix =='1'
                [Pul, avt_data, cycle_data, avtCalcError] = Rhythm.rhythmAvt1_cycle_data_func(tempPul, avt0, -100, 750);
            elseif suffix =='2'
                [Pul, avt_data, cycle_data, avtCalcError] = Rhythm.rhythmAvt2_cycle_data_func(tempPul, avt0, -100, 750);
            end
