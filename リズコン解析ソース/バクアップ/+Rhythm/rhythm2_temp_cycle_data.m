function[avt_temp_data, cycle_data] = rhythm2_temp_cycle_data(x0, Pul, cnst_a, cnst_b, Pul0, bCalc)
...
for t= 2 : n_data
    ...
    % ゼロクロス時
        ...
        if j>1 && S_Pul(j-1,2) ~= 0   % アバター速度計算
            ...
            cycle_data(j,4) = avt_temp_data(t,1); 
        end
